...
$(document).ready(function(){
    ...
    //wins = t
    t = $('<button></button>').addClass('btn btn-secondary m-3').text('PROFIT ').appendTo(n);
        //result = u
    ...
    let donutPriceShow = parseInt($('.button').attr('value'));
    console.log(donutPriceShow);
...
//what next//
//put gg ouside of dd() function
    //create an for loop to read first four values and add at the bottom of the donuts
    //when easy button clicked, view this values
    //wehn normal or expert button clicked, hide this values
//fix average values
    //need a new kind of formula
